  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setOldPrintDate('');
        setNewPrintDate('');
        setCancelItems([{ assession_no: '', item_code: '', qty: 0 }]);
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle>รายการที่ต้องการยกเลิก *</CardTitle>
                  <CardDescription>รายการที่ต้องการ Discontinue</CardDescription>
                </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle>รายการใหม่ (ถ้ามี)</CardTitle>
                  <CardDescription>รายการใหม่ที่ต้องการเพิ่มในวันที่ Print ใหม่</CardDescription>
                </div>
